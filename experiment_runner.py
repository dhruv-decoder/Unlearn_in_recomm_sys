...
with open("experiment_results.csv", "w", newline="") as f:
    ...
    for method in methods:
        for ng in num_groups_list:
            ...
            cmd = [sys.executable, "main.py", "--action", "compare_unlearn",
            ...
            row = {
                ...
                "num_groups": ng,
                "baseline_train_time": baseline_train_time,
                "baseline_prec@5": baseline_prec,
                "baseline_ndcg@5": baseline_ndcg,
                "naive_unlearn_time": naive_unlearn_time,
                "naive_prec_after@5": naive_prec_after,
                "naive_ndcg_after@5": naive_ndcg_after,
                "sisa_train_time": sisa_train_time,
                "sisa_prec_before@5": sisa_prec_before,
                "sisa_ndcg_before@5": sisa_ndcg_before,
                "sisa_unlearn_time": sisa_unlearn_time,
                "sisa_prec_after@5": sisa_prec_after,
                "sisa_ndcg_after@5": sisa_ndcg_after,
            }
            summary_rows.append(row)
            writer.writerow([row[key] for key in [
                "method", "num_groups", "baseline_train_time", "baseline_prec@5", "baseline_ndcg@5",
                "naive_unlearn_time", "naive_prec_after@5", "naive_ndcg_after@5",
                "sisa_train_time", "sisa_prec_before@5", "sisa_ndcg_before@5",
                "sisa_unlearn_time", "sisa_prec_after@5", "sisa_ndcg_after@5"
            ]])
            f.flush()

with open("experiment_summary.json", "w", encoding="utf-8") as jf:
    json.dump({"runs": summary_rows}, jf, indent=2)

print("Done. Results saved to experiment_results.csv, experiment_summary.json and logs/")
